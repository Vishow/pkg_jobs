 ...
 * @since       3.0
 */
class JobsViewLevel extends JViewLegacy
{
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_JOBS_MANAGER_LEVEL_NEW') : JText::_('COM_JOBS_MANAGER_LEVEL_EDIT'), 'level.png');
		...
		JToolBarHelper::help('level', $com = true);
	}
}
