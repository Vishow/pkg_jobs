...
/**
 * View class for a list of contracts.
 *
 * @package     Jobs
 * @subpackage  com_jobs
 * @since       3.0
 */
class JobsViewContracts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		// Load the submenu.
		JobsHelper::addSubmenu('contracts');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_JOBS_MANAGER_CONTRACTS'), 'contracts.png');
		...
		JToolBarHelper::help('contracts', $com = true);

		JHtmlSidebar::setAction('index.php?option=com_jobs&view=contracts');
